...
import {HttpServiceService} from './app.http.service';
// create a dummy data for test
const dummyProductsResponse: Array<Product> =
   [
      {
          ProductRowId: 2,
          ProductId: "PR002",
...
describe('HttpServeice', () => {
  ...
  httpService =  injector.get(HttpServiceService);
...
// successfully
  ...
  it('postData() sould POST and return Product', () => {
    ...
    const prd = new Product(0, 'Prd9012', 'Mobile', 'Electronics', 'ASUS', '64GB', 12000);
    // act
